import pungi.agents.qlearning.policies
...
def test_max_policy_down():
    assert "down" == pungi.agents.qlearning.policies.max_policy({"left": -1, "right": 10, "up": 42, "down": 43.1}, None)


def test_max_policy_up():
    assert "up" == pungi.agents.qlearning.policies.max_policy({"left": -1, "right": 10, "up": 122, "down": 42}, None)


@patch('numpy.random.choice', lambda x, p: x[0])
def test_max_epsilon_greedy_down():
    assert "up" == pungi.agents.qlearning.policies.epsilon_greedy_max_policy({"left": -1, "right": 10, "up": 122, "down": 42}, 0)
...
def test_max_epsilon_greedy_down_explore(random_choice_mock):
    assert "right" == pungi.agents.qlearning.policies.epsilon_greedy_max_policy({"left": -1, "right": 10, "up": 122, "down": 42}, 0)
...
def test_max_epsilon_greedy_up_explore(random_choice_mock):
    assert "down" == pungi.agents.qlearning.policies.epsilon_greedy_max_policy({"left": -1, "right": 10, "up": 122, "down": 42}, 0)
    random_choice_mock.assert_called_once_with(pungi.agents.qlearning.qlearning.DIRECTIONS)
...
def test_load_policy(globals_mock):
    assert tests.mock_policies.mock_policy == pungi.agents.qlearning.policies.get_policy("mock_policy")
